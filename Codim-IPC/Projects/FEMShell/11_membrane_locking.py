...
if __name__ == "__main__":
    ...
    sim.add_shell_3D("input/sphere1K_0.3.obj", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 0)
    ...
    sim.add_shell_3D("input/square21.obj", Vector3d(0, -0.16, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 0)
    sim.set_DBC(
        Vector3d(-0.1, -0.1, -0.1),
    ...
    sim.add_shell_3D("input/square" + size + ".obj", Vector3d(0, 0.16, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 0)
