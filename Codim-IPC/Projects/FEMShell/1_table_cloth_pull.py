...
if __name__ == "__main__":
    ...
    # fixed floor
    floorCounter = sim.add_shell_with_scale_3D(
        "input/tableFloor.obj", Vector3d(-0.5, 0, 0), Vector3d(1, 1, 1), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 0
    )
    ...
    # cloth
    counter = sim.add_shell_3D("input/tableCloth.obj", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 0)
    sim.set_DBC_with_range(
        Vector3d(-0.1, -0.1, 0.2),
        Vector3d(1e-1, 1.1, 0.8),
        Vector3d(v, 0, 0),
        Vector3d(0, 0, 0),
        Vector3d(1, 0, 0),
        0,
    ...
    # geometries
    sim.add_object_3D(
        "../FEM/input/butterPlate.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    butterCounter = sim.add_object_3D(
        "../FEM/input/butter.vtk", Vector3d(0, 0.001, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    sim.add_object_3D(
        "../FEM/input/fork.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    meatCounter = sim.add_object_3D(
        "../FEM/input/meat.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    sim.add_object_3D(
        "../FEM/input/meatPlate.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    sim.add_object_3D(
        "../FEM/input/knife.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    sim.add_object_3D(
        "../FEM/input/glass.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    sim.add_object_3D(
        "../FEM/input/bottle.vtk", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0, Vector3d(1, 1, 1)
    )
    # fixed table
    tableCounter = sim.add_shell_3D("input/table.obj", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)
    sim.set_DBC_with_range(
        Vector3d(-0.1, -0.1, -0.1),
        Vector3d(1.1, 1.1, 1.1),
        Vector3d(0, 0, 0),
    ...
    if algI == 0:
        ...
        sim.initialize(
            ...
            sim.cloth_Ebase[clothI],  # actually only affect bending
            0,
