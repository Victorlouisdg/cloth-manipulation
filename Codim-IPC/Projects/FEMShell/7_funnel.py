...
if __name__ == "__main__":
    ...
    sim.add_shell_3D("input/skirt16x64.obj", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 180)
    sim.set_DBC(
        Vector3d(-0.1, -0.1, -0.1), Vector3d(1.1, 1.1, 1.1), Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 0
    )

    sim.add_shell_3D("input/tet0.1.obj", Vector3d(0, 0.5, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 0)
    sim.set_DBC(
        Vector3d(-0.1, 0.5, -0.1),
    ...
    sim.add_shell_3D("input/square" + size + ".obj", Vector3d(0, 0.2, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 0)
    sim.add_shell_3D("input/square" + size + ".obj", Vector3d(0, 0.25, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 45)
    sim.add_shell_3D("input/square" + size + ".obj", Vector3d(0, 0.3, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 90)
