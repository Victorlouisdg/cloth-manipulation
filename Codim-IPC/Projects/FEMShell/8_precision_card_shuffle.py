...
if __name__ == "__main__":
    ...
    sim.add_shell_3D("input/square21.obj", Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 0)
    # v, rotCenter, rotAxis, angVelDeg
    sim.set_DBC(
        Vector3d(-0.1, -0.1, -0.1), Vector3d(1.1, 1.1, 1.1), Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 0
    )

    counter_lHandle = sim.add_shell_3D(
        "input/card4.obj", Vector3d(-0.09, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 1), -90
    )
    # v, rotCenter, rotAxis, angVelDeg
    sim.set_DBC2_with_range(
    ...
    counter_rHandle = sim.add_shell_3D(
        "input/card4.obj", Vector3d(0.09, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 1), 90
    )
    # v, rotCenter, rotAxis, angVelDeg
    sim.set_DBC2_with_range(
    ...
    for j in range(N):
        ...
        counter.append(
            sim.add_shell_3D(
                "input/card" + size + ".obj",
                Vector3d(-0.05 - 0.22e-3 * i, 0.032 + 0.22e-3 * i, 0),
                Vector3d(0, 0, 0),
                Vector3d(0, 0, 1),
                45,
            )
